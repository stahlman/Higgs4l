...
// taken from: atlas/Event/EventKernel/EventKernel/PdtPdg.h

///
/// This was taken from BaBar, there may be an equivalent in CLHEP
/// The point was to use an enum and not just an int
/// There may be a better place to put this file
/// added by Kyle Cranmer
///

//DRQ: Apparently B0 is defined as a macro on MacOSX (I haven't worked out where yet)
//     This hack gets rid of it
#if defined(__APPLE__) && defined(B0)
#undef B0
#endif
