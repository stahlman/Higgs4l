...
//____________________________________________________________________________
AtlasSFrame::mctype ToolBase::get_mctype()
{
  return dynamic_cast<CycleBase*>(GetParent())->get_mctype();
}

//____________________________________________________________________________
std::string ToolBase::sframe_dir()
{
    return dynamic_cast<CycleBase*>(GetParent())->sframe_dir();
}
...
//____________________________________________________________________________
TH1F* ToolBase::Book( const std::string& name, const std::string& title, int nbins, float min, float max, 
		      const std::string& directory/* = ""*/ )
{

  //  m_logger << WARNING << "BOOKING " << name << " In " << dir << SLogger::endmsg;
  
  TH1F* result = dynamic_cast<TH1F*> (Hist(name,directory));

  //  if(result) m_logger << WARNING << "FOUND HIST " << name << " " << dir << SLogger::endmsg;
...
//   }
//   try {
//     return dynamic_cast<TH1F*> (SToolBase::Hist( name.c_str(), dir.c_str() ));
...
//____________________________________________________________________________
TH1F* ToolBase::Book( const std::string& name, const std::string& title, int nbins, const double* xbins, 
		      const std::string& directory/* = ""*/ )
{
...
//____________________________________________________________________________
TH1F* ToolBase::Book( const std::string& name, const std::string& title, int nbins, const float* xbins, 
		      const std::string& directory/* = ""*/ )
{
...
//____________________________________________________________________________
TH2F* ToolBase::Book( const std::string& name, const std::string& title, int nbinsx, float minx, float maxx, 
		      int nbinsy, float miny, float maxy, const std::string& directory /*=""*/)
{

  TH2F* result = dynamic_cast<TH2F*> (Hist(name,directory));
...
//   try {
//     return dynamic_cast<TH2F*> (SToolBase::Hist( name.c_str(), dir.c_str() ));
//   } catch( const SError& error ) {
...
//____________________________________________________________________________
TH2F* ToolBase::Book( const std::string& name, const std::string& title, int nbinsx, const double* xbins, 
		      int nbinsy, float miny, float maxy, const std::string& directory /*=""*/)
{
...
//____________________________________________________________________________
TH2F* ToolBase::Book( const std::string& name, const std::string& title, int nbinsx, const float* xbins, 
...
void ToolBase::PublishHists()
{
  ...
  TH1F* h_list = 0;
  if( m_histoMap->size()) h_list = SToolBase::Book( TH1F( (std::string(GetName()) + "_hist_list").c_str(), "", 1, 0, 1), GetName().c_str() );
  else return;
...
void ToolBase::CollectHists()
{
  TH1F* h_list = 0;
  try {
    h_list = dynamic_cast<TH1F*> (SToolBase::Hist( (GetName()+"_hist_list").c_str(), GetName().c_str() ));
