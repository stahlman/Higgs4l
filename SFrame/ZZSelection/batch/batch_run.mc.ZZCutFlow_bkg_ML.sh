...
cp $HOME/SFrame/Higgs4lDev/SFrame/ZZSelection/config/*.dtd $HOME/SFrame/Higgs4lDev/SFrame/ZZSelection/batch/batch_mc_ZZCutFlow_bkg_ML_config.xml .
ls -arlt
...
# run SFrame
sframe_main batch_mc_ZZCutFlow_bkg_ML_config.xml
#sframe_main 
