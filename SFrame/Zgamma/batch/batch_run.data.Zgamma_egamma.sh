...
sframe_input.py - $ARGS -d -o input_batch.xml -t egamma $2
...
cp $HOME/SFrame/Higgs4lDev/SFrame/Zgamma/config/*.dtd $HOME/SFrame/Higgs4lDev/SFrame/Zgamma/batch/batch_data_Zgamma_egamma_config.xml .
ls -arlt
...
# run SFrame
sframe_main batch_data_Zgamma_egamma_config.xml
#sframe_main 
