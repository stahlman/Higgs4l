...
cp $HOME/SFrame/Higgs4lDev/SFrame/Zgamma/config/*.dtd $HOME/SFrame/Higgs4lDev/SFrame/Zgamma/batch/batch_mc_Zgamma_config.xml .
ls -arlt
...
# run SFrame
sframe_main batch_mc_Zgamma_config.xml
#sframe_main 
