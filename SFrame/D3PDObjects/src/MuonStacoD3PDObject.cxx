...
#include "../include/MuonStacoD3PDObject.h"

ClassImp( D3PDReader::MuonStacoD3PDObjectElement )
ClassImp( D3PDReader::MuonStacoD3PDObject )
...
namespace D3PDReader {
    ...
    * error prone, it is only visible to the parent class MuonStacoD3PDObject.
    */
   MuonStacoD3PDObjectElement::MuonStacoD3PDObjectElement( size_t index, const MuonStacoD3PDObject& parent )
...
//         EFME_matched( parent.EFME_matched, index, this ),
    ...
    */
   MuonStacoD3PDObjectElement::MuonStacoD3PDObjectElement( const MuonStacoD3PDObjectElement& parent )
      : TObject( parent ),
        E( parent.E ),
        pt( parent.pt ),
        m( parent.m ),
...
//         EFME_matched( parent.EFME_matched ),
    ...
    */
   MuonStacoD3PDObject::MuonStacoD3PDObject( const ::Long64_t& master, const char* prefix )
      : TObject(),
...
//       fHandles[ "EFME_matched" ] = &EFME_matched;
    ...
    * @param prefix Prefix of the variables in the D3PD
    */
   MuonStacoD3PDObject::MuonStacoD3PDObject( const char* prefix )
      : TObject(),
...
//       fHandles[ "EFME_matched" ] = &EFME_matched;
    ...
    */
   const char* MuonStacoD3PDObject::GetPrefix() const {
    ...
    */
   void MuonStacoD3PDObject::SetPrefix( const char* prefix ) {
...
//       EFME_matched.SetName( ::TString( prefix ) + "EFME_matched" );
    ...
    */
   void MuonStacoD3PDObject::ReadFrom( TTree* tree ) {
...
//       EFME_matched.ReadFrom( tree );
    ...
    */
   void MuonStacoD3PDObject::WriteTo( TTree* tree ) {
...
//       EFME_matched.WriteTo( tree );
    ...
    */
   void MuonStacoD3PDObject::SetActive( ::Bool_t active, const ::TString& pattern ) {
    ...
    */
   void MuonStacoD3PDObject::ReadAllActive() {
...
//       if( EFME_matched.IsActive() ) EFME_matched();
    ...
    */
   void MuonStacoD3PDObject::Clear( Option_t* ) {
...
//       EFME_matched()->clear();
    ...
    */
   MuonStacoD3PDObject& MuonStacoD3PDObject::Add( const MuonStacoD3PDObjectElement& el ) {
...
//       }
    ...
    */
   MuonStacoD3PDObjectElement& MuonStacoD3PDObject::operator[]( size_t index ) {

      while( fProxies.size() <= index ) {
         fProxies.push_back( MuonStacoD3PDObjectElement( fProxies.size(), *this ) );
      }
    ...
    * @param index Index of the element inside the collection
    */
   const MuonStacoD3PDObjectElement& MuonStacoD3PDObject::operator[]( size_t index ) const {
    ...
    * @param el The 'element' that should be added to the collection
    */
   MuonStacoD3PDObject& MuonStacoD3PDObject::operator+=( const MuonStacoD3PDObjectElement& el ) {
