...
// -------------------------------------------------------------
#ifndef D3PDREADER_MuonStacoD3PDObject_H
#define D3PDREADER_MuonStacoD3PDObject_H
...
namespace D3PDReader {
    ...
    *  user = jdegenha
    *  time = Mon Nov  7 10:17:13 2011
    */
   class MuonStacoD3PDObjectElement : public TObject {

      friend class MuonStacoD3PDObject;

   protected:
      /// Constructor only visible to MuonStacoD3PDObject
      MuonStacoD3PDObjectElement( size_t index, const MuonStacoD3PDObject& parent );

   public:
      /// Copy constructor
      MuonStacoD3PDObjectElement( const MuonStacoD3PDObjectElement& parent );
...
//       VarProxy< int > EFME_matched;
      ...
      ClassDef( MuonStacoD3PDObjectElement, 0 )

   }; // class MuonStacoD3PDObjectElement
    ...
    *  time = Mon Nov  7 10:17:13 2011
    */
   class MuonStacoD3PDObject : public TObject {

   public:
      /// Constructor used when reading from a TTree
      MuonStacoD3PDObject( const ::Long64_t& master, const char* prefix = "mu_staco_" );
      /// Constructor when the object is only used for writing data out
      MuonStacoD3PDObject( const char* prefix = "mu_staco_" );
      ...
      MuonStacoD3PDObject& Add( const MuonStacoD3PDObjectElement& el );

      /// Access a proxy class describing one element of the container
      MuonStacoD3PDObjectElement& operator[]( size_t index );
      /// Access a proxy class describing one element of the container (constant version)
      const MuonStacoD3PDObjectElement& operator[]( size_t index ) const;
      /// Add one element to an output collection
      MuonStacoD3PDObject& operator+=( const MuonStacoD3PDObjectElement& el );
...
//       VarHandle< vector<int>* > EFME_matched;
   ...
   private:
      mutable std::vector< MuonStacoD3PDObjectElement > fProxies; ///< Internal list of proxy objects
      ...
      ClassDef( MuonStacoD3PDObject, 0 )

   }; // class MuonStacoD3PDObject

} // namespace D3PDReader

#endif // D3PDREADER_MuonStacoD3PDObject_H
