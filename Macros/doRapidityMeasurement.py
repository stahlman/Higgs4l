...
ZZ_bkg_syst_file  = "/disk/userdata00/atlas_data2/stahlman/output/Fall2013/Systematics/v02/IrreducibleBackgroundSystematics.rapidity.txt"
red_bkg_syst_file = "/disk/userdata00/atlas_data2/stahlman/output/Fall2013/Systematics/v02/ReducibleBackgroundSystematics.rapidity.txt"
signal_syst_file  = "/disk/userdata00/atlas_data2/stahlman/output/Fall2013/Systematics/v02/SignalSystematics.rapidity.txt"

variable = "abs(y4l_unconstrained)"
var_name = 'rapidity'
var_label_reco = '|y_{4l}|'
var_label_truth = '|y|'
var_unit = ""
var_bins = [0.0, 0.3, 0.65, 1.0, 1.4, 2.4]
